...
$string['config_color_course_card'] = 'بطاقة المسابقة';
$string['config_color_course_title'] = 'عنوان المسابقة';
$string['config_color_course_price'] = 'سعر المسابقة';
...
$string['event'] = 'حدث';
$string['rated_by'] ='{$a} تقييم المتسابق';
$string['rate_course'] ='تقديم التقييم';
$string['number_of_courses'] ='أكثر {$a} مسابقات';
$string['number_of_subcategories'] ='أكثر {$a} مسابقات';
$string['categories'] = 'فئات';
$string['hidden'] ='مخفي';
$string['back_to_course'] ='العودة للمسابقة';
$string['back_to_site'] ='العودة إلى الموقع';
$string['course_navigation'] ='التنقل في المسابقة';
...
// Theme Edumy
$string['studentsiamteaching'] = 'متسابقون أُدرس لهم';
$string['coursesiamteaching'] = 'مسابقات';
$string['coursesiamtaking'] = 'مسابقات';
...
$string['search_courses'] = 'بحث المسابقات...';
...
$string['share'] = 'مشاركة';
$string['students_enrolled'] = 'المتسابقون الملتحقين';
...
$string['course_buy_access'] = 'دخول المسابقة المدفوعة';
$string['course_enrolled'] = 'أنت مسجّل';
$string['course_enrolled_text'] = 'أنت مسجل حاليًا في هذه المسابقة';
$string['course_enrolled_teacher'] = 'أنت تدرس';
$string['course_enrolled_teacher_text'] = 'أنت تقوم حاليًا بتدريس هذه المسابقة.';
$string['course_error_title'] = 'خطأ بالتسجيل';
$string['course_error_text'] = 'لم يقم المسؤول لديك بإتمام إعدادات التسجيل ب PayPal أو Stripe لهذه المسابقة.';
...
$string['total'] = 'الكل';
$string['total_courses'] = 'المسابقات';
$string['price'] = 'السعر';
$string['course_id'] = 'معرف المسابقة';
$string['action'] = 'إجراء';
...
$string['preview_course'] = 'استعراض المسابقة';
$string['library'] = 'المكتبة';
$string['have_an_account'] = 'تمتلك حساب?';
$string['course_content'] = 'محتوى المسابقة';
...
$string['no_students_yet'] = 'لا يوجد متسابقون حتى الآن';
$string['no_courses_yet'] = 'لا توجد مسابقات بعد';
