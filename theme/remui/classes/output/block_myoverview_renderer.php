...
class block_myoverview_renderer extends \block_myoverview\output\renderer {
    ...
    public function render_main(\block_myoverview\output\main $main) {
        ...
        $templatecontext['layouts'][0]->edwicon = "edw-icon edw-icon-Card-View";
        $templatecontext['layouts'][1]->edwicon = "edw-icon edw-icon-List-View-08";
        $templatecontext['layouts'][2]->edwicon = "edw-icon edw-icon-Topic-View";
