...
trait typography {
    ...
    private function add_global_typography_body() {
        ...
        $this->add_root_typography_settings();
        ...
        $this->add_small_para_font_settings();

        $this->add_small_info_font_settings();
    ...
    private function add_global_typography_textlink() {
        ...
        //     'heading_start',
        //     'textlink',
        //     get_string('textlink', 'theme_remui'),
        //     'typography',
        //     [
        //         'collapsed' => true
        //     ]
     ...
     * @return void
     */
    private function add_small_info_font_settings() {
        $this->add_setting(
            'heading_start',
            'smallinfo-font',
     ...
     *
     */
    private function add_small_para_font_settings() {
        $this->add_setting(
            'heading_start',
            'smallpara-font',
     ...
     * @return void
     */
    private function add_root_typography_settings() {
        $fonts = $this->get_fonts([
            'inherit' => get_string('inherit', 'theme_remui'),
            'Standard' => 'Standard'
        ]);
