...
function setPrimaryColor() {
    ...
    .block-myoverview [data-region="filter"] .nav-tabs .nav-grouping-selector .nav li.nav-item [aria-current="true"] {
...
function handleLightBorderColor() {
    ...
    let content = `
        ...
        table.dataTable tbody td,
        table.dataTable tbody th,
        section#region-main .maincalendar td:not(:last-child), aside:not(#block-region-side-pre) .maincalendar td:not(:last-child) {
